    ...
    return (
      <div className="flex items-center justify-center h-64">
        <div className="flex items-center gap-3">
          ...
          <span style={{ color: 'var(--text-secondary)' }}>Loading user...</span>
        </div>
      </div>
    );
  }
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div className="flex items-center">
              <label className="flex items-center gap-3 px-3.5 py-2.5 rounded-lg cursor-pointer" style={{ border: '1px solid var(--border-color)' }}>
                ...
                <span className="text-sm font-medium" style={{ color: 'var(--text-on-card)' }}>Active User</span>
              </label>
            </div>
          </div>
        </div>
