...
export default function NewClientPage() {
  ...
  function validate() {
    ...
    if (form.gstNumber && !/^[0-9]{2}[A-Z]{5}[0-9]{4}[A-Z]{1}[1-9A-Z]{1}Z[0-9A-Z]{1}$/.test(form.gstNumber.toUpperCase())) {
      errs.gstNumber = "Invalid GST (e.g. 29ABCDE1234F1Z5)";
    }
    return errs;
  }
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        <div className="keka-card p-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <Input label="Email" name="email" type="email" value={form.email} onChange={handleChange} required error={errors.email} placeholder="client@company.com" />
